...
$durumlar = [
  ...
  'teklif_verildi' => ['Randevu Verildi','bg-primary'],
  'kazanildi' => ['Tamamlandı','bg-success'],
  'kaybedildi' => ['İptal','bg-secondary'],
];
...
<div class="card mb-4">
  <div class="card-header d-flex justify-content-between">
    <div><i class="bi bi-calendar2-check me-2" style="color:var(--primary)"></i><strong>Randevu #<?= $detay['id'] ?></strong> — <?= e($detay['ad']) ?></div>
  ...
  <div class="card-body">
    <div class="row g-3 mb-3">
      ...
      <div class="col-md-3"><small class="text-muted">Bölüm / Tedavi</small><div><strong><?= e($detay['hizmet']) ?></strong></div></div>
      ...
      <div class="col-md-3"><small class="text-muted">Tercih Saati</small><div><?= e($detay['alan'])?:'—' ?></div></div>
      <div class="col-md-3"><small class="text-muted">Randevu Tipi</small><div><?= e($detay['butce'])?:'—' ?></div></div>
      <div class="col-md-3"><small class="text-muted">Ne Zaman</small><div><?= e($detay['baslangic'])?:'—' ?></div></div>
      <div class="col-12"><small class="text-muted">Şikayet / Notlar</small><div style="white-space:pre-wrap;background:#f9fafb;padding:.8rem;border-radius:6px"><?= e($detay['detay'])?:'—' ?></div></div>
    </div>
    <hr>
...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
    <div><i class="bi bi-calendar2-check me-2"></i>Tüm Randevu Talepleri (<?= count($liste) ?>)</div>
  ...
  <div class="table-responsive">
    <table class="table table-hover align-middle mb-0">
      <thead><tr><th>#</th><th>Ad</th><th>Telefon</th><th>Bölüm</th><th>Tip</th><th>Durum</th><th>Tarih</th><th></th></tr></thead>
      <tbody>
      ...
      <?php endforeach; ?>
      <?php if(empty($liste)): ?><tr><td colspan="8" class="text-center text-muted py-4">Henüz randevu talebi yok.</td></tr><?php endif; ?>
      </tbody>
    </table>
  </div>
</div>
