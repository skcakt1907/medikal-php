    ...
    <div class="collapse navbar-collapse" id="nav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item nav-dropdown">
          <a class="nav-link <?= in_array($current,['hizmetler.php','hizmet-detay.php'])?'active':'' ?>" href="<?= SITE_URL ?>/hizmetler">Tedavilerimiz <i class="bi bi-chevron-down ms-1" style="font-size:.7rem"></i></a>
        ...
        <li class="nav-item"><a class="nav-link <?= in_array($current,['projeler.php','proje-detay.php'])?'active':'' ?>" href="<?= SITE_URL ?>/projeler">Kliniğimiz</a></li>
        <li class="nav-item"><a class="nav-link <?= in_array($current,['blog.php','blog-detay.php'])?'active':'' ?>" href="<?= SITE_URL ?>/blog">Sağlık Rehberi</a></li>
